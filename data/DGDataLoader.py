...
officehome_dataset = ['Art', 'Product', 'Clipart', 'Real_World']
vlcs_dataset = ['caltech','labelme','pascal','sun']
available_datasets =  pacs_dataset 
# available_datasets = pacs_dataset + officehome_dataset + digits_datset + vlcs_dataset
